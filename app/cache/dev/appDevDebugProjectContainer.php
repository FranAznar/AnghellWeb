...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'aa20030fa188f629ed8e230818aa6fa1ef5e9eccd4bd2faad3c1fe272939a1a0_1' => 'getAa20030fa188f629ed8e230818aa6fa1ef5e9eccd4bd2faad3c1fe272939a1a01Service',
            ...
            'cc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba_1' => 'getCc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba1Service',
            'cc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba_2' => 'getCc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba2Service',
            'cc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba_3' => 'getCc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba3Service',
    ...
    /**
     * Gets the 'aa20030fa188f629ed8e230818aa6fa1ef5e9eccd4bd2faad3c1fe272939a1a0_1' service.
     *
     ...
     */
    protected function getAa20030fa188f629ed8e230818aa6fa1ef5e9eccd4bd2faad3c1fe272939a1a01Service()
    {
        return $this->services['aa20030fa188f629ed8e230818aa6fa1ef5e9eccd4bd2faad3c1fe272939a1a0_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/AnghellWeb/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/AnghellWeb/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/var/www/AnghellWeb/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/AnghellWeb/app/Resources');
    ...
    /**
     * Gets the 'cc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getCc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba1Service()
    {
        return $this->services['cc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the 'cc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getCc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba2Service()
    {
        return $this->services['cc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the 'cc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getCc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba3Service()
    {
        return $this->services['cc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_a836d0fe49cfab2128e1366d381ad550f2214f0d711a05b43241da948e696cc8');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_a836d0fe49cfab2128e1366d381ad550f2214f0d711a05b43241da948e696cc8');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_a836d0fe49cfab2128e1366d381ad550f2214f0d711a05b43241da948e696cc8');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/var/www/AnghellWeb/src/AnghellWeb/BackendBundle/Entity')), 'AnghellWeb\\BackendBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('BackendBundle' => 'AnghellWeb\\BackendBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/var/www/AnghellWeb/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/AnghellWeb/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('aa20030fa188f629ed8e230818aa6fa1ef5e9eccd4bd2faad3c1fe272939a1a0_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/AnghellWeb/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/var/www/AnghellWeb/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/AnghellWeb/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/var/www/AnghellWeb/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/AnghellWeb/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/AnghellWeb/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/AnghellWeb/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['sonata.admin.route.cache'] = new \Sonata\AdminBundle\Route\RoutesCache('/var/www/AnghellWeb/app/cache/dev/sonata/admin', true);
    }
    ...
    {
        return $this->services['sonata.block.loader.service'] = new \Sonata\BlockBundle\Block\Loader\ServiceLoader(array(0 => 'sonata.admin.block.admin_list', 1 => 'sonata.block.service.text', 2 => 'sonata.block.service.rss', 3 => 'sonata.block.service.action'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('cc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba_1'), 1 => $this->get('cc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba_2'), 2 => $this->get('cc312bc1059e74a749935151dd65b381a17f210eb4e6c1d3384481f1a99f7dba_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/AnghellWeb/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/var/www/AnghellWeb/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/AnghellWeb/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/var/www/AnghellWeb/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/AnghellWeb/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/var/www/AnghellWeb/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/var/www/AnghellWeb/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/var/www/AnghellWeb/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/var/www/AnghellWeb/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/var/www/AnghellWeb/src/AnghellWeb/BackendBundle/Resources/views', 'Backend');
        $instance->addPath('/var/www/AnghellWeb/src/AnghellWeb/FrontendBundle/Resources/views', 'Frontend');
        $instance->addPath('/var/www/AnghellWeb/vendor/sonata-project/core-bundle/Resources/views', 'SonataCore');
        $instance->addPath('/var/www/AnghellWeb/vendor/sonata-project/block-bundle/Resources/views', 'SonataBlock');
        $instance->addPath('/var/www/AnghellWeb/vendor/sonata-project/admin-bundle/Resources/views', 'SonataAdmin');
        $instance->addPath('/var/www/AnghellWeb/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/var/www/AnghellWeb/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/var/www/AnghellWeb/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/var/www/AnghellWeb/app/Resources/views');
        $instance->addPath('/var/www/AnghellWeb/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        $instance->addPath('/var/www/AnghellWeb/vendor/knplabs/knp-menu/src/Knp/Menu/Resources/views');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/var/www/AnghellWeb/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/AnghellWeb/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/AnghellWeb/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/AnghellWeb/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/AnghellWeb/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/AnghellWeb/app/cache/dev',
            'kernel.logs_dir' => '/var/www/AnghellWeb/app/logs',
            'kernel.bundles' => array(
                ...
                'BackendBundle' => 'AnghellWeb\\BackendBundle\\BackendBundle',
                'FrontendBundle' => 'AnghellWeb\\FrontendBundle\\FrontendBundle',
            ...
            'debug.container.dump' => '/var/www/AnghellWeb/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/var/www/AnghellWeb/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/var/www/AnghellWeb/app/cache/dev/profiler',
            ...
            'router.resource' => '/var/www/AnghellWeb/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/AnghellWeb/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/var/www/AnghellWeb/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/var/www/AnghellWeb/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/var/www/AnghellWeb/app/../web',
            'assetic.write_to' => '/var/www/AnghellWeb/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/AnghellWeb/app/cache/dev/doctrine/orm/Proxies',
